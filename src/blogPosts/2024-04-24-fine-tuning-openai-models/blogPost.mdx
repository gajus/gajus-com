...
```ts
it('extracts mentions of geogrpahical locations (city with inferred country)', async () => {
...
This approached felt far more productive than my intial approach of mucking with JSON files.

## Conclusion

If you are optimizing for speed, fine-tunning OpenAI models is going to be an improvement. However, it is not going to be [the fastest option out there](https://thefastest.ai/).

If you are optimizing for cost or accuracy, fine-tunning OpenAI models is going to be definitely worth it.
