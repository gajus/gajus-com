---
description: Facebook DataLoader is a generic utility to be used as part of your application data fetching layer to provide a simplified and consistent API over various remote data sources such as databases or web services via batching and caching.
guid: 018b1756-4d3f-7536-ba7a-1cee929e6404
publishedAt: 2016-08-19T14:59:43
tags: [engineering, javascript, graphql, batching, caching]
title: Using DataLoader to batch queries
---
